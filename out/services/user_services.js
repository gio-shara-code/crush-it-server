        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_2 = _a.sent();
                        console.log("UserService[getUserById] failed: " + e_2);
                        return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_3 = _a.sent();
                        console.log("UserService[getUserById] failed: " + e_3);
                        return [2 /*return*/];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user_model_1.default.find({ email: email })];
                    case 1:
                        docs = _a.sent();
                        if (docs.length !== 0)
                    ...
                    case 2:
                        e_4 = _a.sent();
                        console.log("UserService[checkUserExistency] failed: " + e_4);
                        return [2 /*return*/, true];
